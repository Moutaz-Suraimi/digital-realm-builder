        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-10">
          {options.map((opt, i) => {
            ...
            return (
              ...
              >
                <opt.icon className={`w-8 h-8 mb-3 ${isSelected ? "text-primary" : "text-muted-foreground"}`} />
                <h3 className={`text-lg font-semibold mb-1 ${isSelected ? "text-primary" : "text-foreground"}`}>
                  {t(opt.key)}
                </h3>

...
const testimonials: Testimonial[] = [
  {
    ...
    role: { ar: "مؤسس متجر إلكتروني", en: "E-Commerce Founder", zh: "电商创始人" },
    text: {
            ...
            <ScrollReveal key={i} delay={i * 0.12} direction={i % 2 === 0 ? "left" : "right"}>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground text-sm">{item.name[l] || item.name.en}</p>
                    <p className="text-xs text-muted-foreground">{item.role[l] || item.role.en}</p>
                  </div>
                </div>
              </motion.div>
            </ScrollReveal>
